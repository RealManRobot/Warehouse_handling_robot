...
result = cJSON_GetObjectItem(root, "waypoint");
    ...
    if (json_member != NULL && json_member->type == cJSON_Array)
    {
        ...
        if (size == 3)
        {
            ...
            udp_arm_euler.Px = Udp_RM_Joint.joint_position[0];
            udp_arm_pose.position.y = Udp_RM_Joint.joint_position[1];
            udp_arm_euler.Py = Udp_RM_Joint.joint_position[1];
            udp_arm_pose.position.z = Udp_RM_Joint.joint_position[2];
            udp_arm_euler.Pz = Udp_RM_Joint.joint_position[2];
        }
        else
        {
            cJSON_Delete(root);
    ...
    if (json_member != NULL && json_member->type == cJSON_Array)
    {
        ...
        if (size == 3)
        {
            ...
            udp_arm_euler.Rx = Udp_RM_Joint.joint_euler[0];
            udp_arm_euler.Ry = Udp_RM_Joint.joint_euler[1];
            udp_arm_euler.Rz = Udp_RM_Joint.joint_euler[2];
